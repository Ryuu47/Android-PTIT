package com.example.sachtablayout.dal;
...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql= "Create table items(" +
                ...
                "title text, author text, category text, price text, date text)";
        db.execSQL(sql);
    }
    ...
    public List<Item>getAll(){
        ...
        while (rs!=null && rs.moveToNext()){
            ...
            list.add(new Item(id,  title, author, c ,p, date));
        }
        return list;
    }
    ...
    public List<Item> searchByTitle(String key){
        ...
        while (rs!=null && rs.moveToNext()){
            ...
            list.add(new Item(id, title,author, c ,p, d));
        }
        return list;
    }
    ...
    public List<Item> getStatistic(){
        ...
        List<Item> list = new ArrayList<>();
        Cursor rs = sqLiteDatabase.query("items", new String[]{"id", "title","author","category","MAX(price) AS price","date"}, null,
                null, "category",
                null,"price DESC");
        while (rs!=null && rs.moveToNext()){
            int id= rs.getInt(0);
